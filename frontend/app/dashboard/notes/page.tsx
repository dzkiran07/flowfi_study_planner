...
import { Search, Plus, Trash2, X, StickyNote, FileText } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6 dark:bg-slate-900">
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {filteredNotes.map((note) => (
              <div
                ...
                className={`group relative flex cursor-pointer flex-col rounded-2xl border border-l-4 border-slate-200 bg-white p-5 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md dark:border-slate-700 dark:bg-slate-800 ${
      ...
      {selectedNote && (
        ...
        >
          <div
            className="w-full max-w-lg overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl dark:border-slate-700 dark:bg-slate-800"
            onClick={(e) => e.stopPropagation()}
          >
            <div
